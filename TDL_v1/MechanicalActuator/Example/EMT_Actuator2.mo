...
model EMT_Actuator2
  ...
  Modelica.Mechanics.Translational.Interfaces.Flange_b flange_clutch annotation(Placement(transformation(extent={{-150,
            -176},{-130,-156}})));
...
equation
  ...
  connect(flange_clutch,mass.flange_a) annotation(Line(points={{-140,-166},{-140,
  ...
  connect(signalVoltage.p, dCPM.pin_ap) annotation (Line(
      points={{-140,90},{-130,90},{-130,61.6},{-144,61.6}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(dCPM.pin_an, signalVoltage.n) annotation (Line(
      points={{-156,61.6},{-158,61.6},{-158,62},{-168,62},{-168,90},{-160,90}},
      color={0,0,255},
      smooth=Smooth.None));
  ...
  connect(ideal_Cam2_3.flange_cam, inertia4.flange_b) annotation (Line(
      points={{170,-120},{170,-90},{190,-90},{190,-80}},
      color={0,0,0},
      smooth=Smooth.None));
  connect(ideal_Cam2_4.flange_cam, inertia4.flange_b) annotation (Line(
      points={{240,-120},{240,-90},{190,-90},{190,-80}},
      color={0,0,0},
      smooth=Smooth.None));
  ...
  connect(ideal_Cam2_4.flange_follower, flange_syn_so) annotation (Line(
      points={{240,-140},{240,-166},{220,-166}},
      color={0,127,0},
      smooth=Smooth.None));
