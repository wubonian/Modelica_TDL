...
model PMSM
  ...
  TDL_v1.BasicComponents.Friction.Rotational.Rotational_ContinuousCoulombFriction
    rotational_Continuous_Friction_Tanh(
    parm_w_limit=1e-4,
    parm_mue=1,
    parm_cgeo=1) annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=90,
        origin={70,-50})));
  ...
  //-----------------------fault Components-------------------------------------
  Modelica.Blocks.Sources.Constant Normal_Bear(k=0)
...
equation
  ...
  connect(strayLoad.flange, inertiaRotor.flange_a) annotation (Line(
      ...
      color={0,0,0},
      smooth=Smooth.None));
  connect(permanentMagnet.spacePhasor_r, airGapR.spacePhasor_r) annotation (
      Line(
      points={{22,-22},{12,-22},{12,-10}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(permanentMagnet.flange, inertiaRotor.flange_a) annotation (Line(
      points={{32,-22},{60,-22},{60,0}},
      color={0,0,0},
      smooth=Smooth.None));
  connect(permanentMagnet.support, internalSupport) annotation (Line(
      points={{32,-42},{32,-80},{40,-80}},
      color={0,0,0},
      smooth=Smooth.None));
  connect(permanentMagnet.heatPort, internalThermalPort.heatPortPermanentMagnet)
    annotation (Line(
      points={{22,-42},{22,-74},{-40,-74}},
      color={191,0,0},
      smooth=Smooth.None));
  connect(spacePhasorS.plug_p, rs.plug_n) annotation (Line(
      ...
      color={0,0,255},
      smooth=Smooth.None));
  connect(Normal_Bear.y, rotational_Continuous_Friction_Tanh.f_input)
    annotation (Line(
      points={{-31.6,-50},{60,-50}},
      color={0,0,127},
      smooth=Smooth.None));
