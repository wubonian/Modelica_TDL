...
model EMT3_Fault
  ...
  TDL_v1.Transmission.Synchronizer.Synchronizer3_Fault synchronizer_12(
    J_ring=0.001,
    J_hub_sleeve=1e-3,
  ...
  TDL_v1.Transmission.Synchronizer.Synchronizer3_Fault synchronizer_34(
    J_ring=0.001,
    J_hub_sleeve=1e-3,
    ring_engaged_d_gain=1,
    gear_engaged_d_gain=1,
  ...
  TDL_v1.Transmission.Synchronizer.Synchronizer3_Fault synchronizer_si5(
  ...
  TDL_v1.Transmission.Synchronizer.Synchronizer3_Fault synchronizer_so(
  ...
  TDL_v1.Transmission.Gear.Physical_Gear idealGear2_8(i=1) annotation (
      Placement(transformation(
        ...
        rotation=-90,
        origin={100,78})));
  Clutch.Clutch_Fault clutch_Fault(useNormalModel=false,
    fault_DiaphragmSpring(tableOnFile_large_edge=true, tableOnFile_small_edge=true,fileName_large_edge=
...
equation
  ...
  connect(flange_syn_1_2, synchronizer_12.flange_a) annotation (Line(
      ...
      color={0,127,0},
      smooth=Smooth.None));
  connect(flange_engine, clutch_Fault.Engine_Flange) annotation (Line(
      points={{-200,0},{-180,0}},
      color={0,0,0},
      smooth=Smooth.None));
  connect(clutch_Fault.Transmission_Flange, input_shaft.flange_a) annotation (
      Line(
      points={{-160,0},{-140,0}},
      color={0,0,0},
      smooth=Smooth.None));
  connect(clutch_Fault.Actuator_Flange, flange_clutch) annotation (Line(
      points={{-160,16},{-140,16},{-140,116}},
      color={0,127,0},
      smooth=Smooth.None));
  connect(faultBus, clutch_Fault.faultBus) annotation (Line(
      points={{-200,60},{-170,60},{-170,18}},
      color={255,0,0},
      thickness=0.5,
      ...
      index=-1,
      extent={{-6,3},{-6,3}}));
  connect(faultBus, synchronizer_12.faultBus) annotation (Line(
      points={{-200,60},{-60,60},{-60,-58}},
      color={255,0,0},
      thickness=0.5,
      smooth=Smooth.None), Text(
      string="%first",
      index=-1,
      extent={{-6,3},{-6,3}}));
  connect(faultBus, synchronizer_34.faultBus) annotation (Line(
      points={{-200,60},{60,60},{60,16}},
      color={255,0,0},
      thickness=0.5,
      smooth=Smooth.None), Text(
      string="%first",
      index=-1,
      extent={{-6,3},{-6,3}}));
  connect(faultBus, synchronizer_si5.faultBus) annotation (Line(
      points={{-200,60},{60,60},{60,26},{152,26},{152,16}},
      color={255,0,0},
      thickness=0.5,
      smooth=Smooth.None), Text(
      string="%first",
      index=-1,
      extent={{-6,3},{-6,3}}));
  connect(faultBus, synchronizer_so.faultBus) annotation (Line(
      points={{-200,60},{60,60},{60,92},{154,92},{154,62}},
      color={255,0,0},
      thickness=0.5,
      smooth=Smooth.None), Text(
      string="%first",
