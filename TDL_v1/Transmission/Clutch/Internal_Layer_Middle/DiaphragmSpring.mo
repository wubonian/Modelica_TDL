...
equation
  ...
  large_edge.distance_rel=1000*s_rel_large_edge;//smooth(1,if s_rel_large_edge<0 then 1000*s_rel_large_edge else 0);
  large_edge.speed_rel=v_rel_large_edge;

  small_edge.d=d_small_edge;
  small_edge.distance_rel=1000*s_rel_small_edge;//smooth(1,if s_rel_small_edge<0 then 1000*s_rel_small_edge else 0);
