...
model Translational_SpringDamper
  parameter SpringAndDamper.Types.Mode_T mode_select=SpringAndDamper.Types.Mode_T.LL;
  parameter Modelica.SIunits.TranslationalSpringConstant c=1 annotation(Dialog(enable = mode == 1 or mode==3));
  parameter Modelica.SIunits.TranslationalDampingConstant d=1 annotation(Dialog(enable= mode==1 or mode==2));
  ...
  Translational.Translational_LinearSpringLinearDamper mode_1(c_LL=c, d_LL=d) if
                                           mode==1
    annotation (Placement(transformation(extent={{-10,50},{10,70}})));
  Translational.Translational_NonlinearSpringLinearDamper mode_2(
  ...
  Translational.Translational_LinearSpringNonlinearDamper mode_3(
  ...
  Translational.Translational_NonlinearSpringNonlinearDamper mode_4(
...
protected
  parameter Integer mode=if mode_select==SpringAndDamper.Types.Mode_T.LL then 1 elseif mode_select==SpringAndDamper.Types.Mode_T.NL then 2
 elseif
       mode_select==SpringAndDamper.Types.Mode_T.LN then 3 else 4;
equation
...
end Translational_SpringDamper;
