  ...
  TDL_v1.MechanicalActuator.Cam.Ideal_Cam2 ideal_Cam(
    ...
    fileName="D:/Library_Update/TDL_Workspace/Cam/cam.mat") annotation (
      Placement(transformation(
        ...
        rotation=-90,
        origin={122,-86})));
  TDL_v1.Transmission.Synchronizer.Synchronizer2 synchronizer2_1(sleeve(f_max=
          5000), f_max=3000)
    annotation (Placement(transformation(extent={{110,-180},{130,-160}})));
  TDL_v1.Transmission.Synchronizer.Synchronizer2 synchronizer2_2
    annotation (Placement(transformation(extent={{208,-110},{228,-90}})));
  TDL_v1.MechanicalActuator.Cam.Ideal_Cam2 ideal_Cam1(
    tableOnFile=true,
